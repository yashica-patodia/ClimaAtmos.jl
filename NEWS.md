...
- [#PRNUM](https://github.com/CliMA/ClimaAtmos.jl/pull/PRNUM) ![][badge-✨feature/enhancement] Richardson-number stability weight on the geometric SGS
  ...
  term where the resolved flow is turbulent or conditionally unstable. The applied weight is reported by the new `sgs_geo_weight` diagnostic.
